...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      registerInviteAdmin: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerInviteAdmin',
                                     ...
                                     'Invites.compact line 30 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      acceptInviteAdmin: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('acceptInviteAdmin',
                                     'argument 1 (as invoked from Typescript)',
                                     'Invites.compact line 35 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(inviteCode_0.buffer instanceof ArrayBuffer && inviteCode_0.BYTES_PER_ELEMENT === 1 && inviteCode_0.length === 32)) {
      ...
      registerInviteClinic: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerInviteClinic',
                                     'argument 1 (as invoked from Typescript)',
                                     'Invites.compact line 49 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(inviteCode_0.buffer instanceof ArrayBuffer && inviteCode_0.BYTES_PER_ELEMENT === 1 && inviteCode_0.length === 32)) {
      ...
      acceptInviteClinic: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`acceptInviteClinic: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const inviteCode_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('acceptInviteClinic',
                                     'argument 1 (as invoked from Typescript)',
                                     'Invites.compact line 54 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(inviteCode_0.buffer instanceof ArrayBuffer && inviteCode_0.BYTES_PER_ELEMENT === 1 && inviteCode_0.length === 32)) {
        ...
        const result_0 = this._acceptInviteClinic_0(context,
                                                    partialProofData,
                                                    inviteCode_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      acceptInviteClinic: this.circuits.acceptInviteClinic,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('acceptInviteClinic', new __compactRuntime.ContractOperation());
  ...
  _acceptInviteClinic_0(context, partialProofData, inviteCode_0) {
    __compactRuntime.assert(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
